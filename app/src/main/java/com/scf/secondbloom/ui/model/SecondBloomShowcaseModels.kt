...
data class InspirationCardUiModel(
    ...
    val beforeImageAssetId: String? = null,
    val afterImageAssetId: String? = null,
...
object SecondBloomShowcaseContent {
    ...
    fun publishedInspirationCards(
        ...
        InspirationCardUiModel(
            ...
            beforeImageAssetId = record.previewResult.beforeImage?.assetId,
            afterImageAssetId = record.previewResult.afterImage?.assetId,
